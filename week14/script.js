...
$(document).ready(function () {
    ...
    $("#contact-submit").on("click", function (e) {
      ...
      let settings = {
        "async": true,
        "crossDomain": true,
        "url": "https://interactivedev-a655.restdb.io/rest/contact-04  ",
      ...
      $.ajax(settings).done(function (response) {
        ...
        for (var i = 0; i < response.length && i < limit; i++) {
          ...
          */
          ...
          data-msg='${response[i].message}' data-name='${response[i].name}' 
    ...
    function updateForm(id, contactName, contactEmail, contactMsg) {
      ...
      var settings = {
        "async": true,
        "crossDomain": true,
        "url": `https://interactivedev-a655.restdb.io/rest/contact-04/${id}`,//update based on the ID
        "method": "PUT",
        "headers": {
          "content-type": "application/json",
          "x-apikey": APIKEY,
  ...
  var settings = {
    "async": true,
    "crossDomain": true,
    "url": "https://interactivedev-a655.restdb.io/rest/contact-04/(ObjectID)",
    "method": "DELETE",
    "headers": {
      "content-type": "application/json",
